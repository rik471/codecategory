...
class CategoryTest extends AbstractTestCase
{
    ...
    public function test_should_check_if_it_is_valid_when_it_is()
    {
        ...
        $validator->shouldReceive('setRules')->with(['name' => 'requires|max:255']);
    ...
    {
        $category = Category::create(["name" => 'Category Test', 'active'=> true]);
        $post1 = Post::create(['title' => 'meu post 1', 'content' => 'content test 1']);
        $post2 = Post::create(['title' => 'meu post 2', 'content' => 'content test 1']);
